...
<section id="title">
  <div class="container">  
    ...
    <h1>
     Песок, щебень, бут, отсев <span class="smaller">за 2 часа по ценам производителя</span>
    </h1>
    <p id="offer">
    ...
    <div id="menus_wrapper">
      <div id="materials">
        ...
        <div class="material_row">            
          <div class="col col_2" data-value="Песок: КРЗ">Песок КРЗ</div>
          <div class="col col_2" data-value="Песок: Серо-зелёный">Серо<br>зелёный</div>
          <div class="col col_2" data-value="Песок: Басьяновский">Басьяновский</div>
          <div class="col col_2" data-value="Песок: Речной крупный">Речной<br>крупный</div>
          <div class="col col_2" data-value="Песок: Речной мелкий">Речной<br>мелкий</div>
          <div class="col col_2" data-value="Песок: Шлаковый">Шлаковый</div>
          <div class="clearfix"></div>
        </div>
        <h4>Щебень</h4>
        <div class="material_row">            
          <div class="col col_20" data-value="Щебень: Горный фр. 0-5">Горный<br>фр. 0-5</div>
          <div class="col col_20" data-value="Щебень: Горный фр. 0-10">Горный<br>фр. 0-10</div>
          <div class="col col_20" data-value="Щебень: Горный фр. 3-10">Горный<br>фр. 3-10</div>
          <div class="col col_20" data-value="Щебень: Горный фр. 5-20">Горный<br>фр. 5-20</div>
          <div class="col col_20" data-value="Щебень: Горный фр. 20-40">Горный<br>фр. 20-40</div>
          <div class="clearfix"></div>
          <div class="col col_20" data-value="Щебень: Горный фр. 40-70">Горный<br>фр. 40-70</div>
          <div class="col col_20" data-value="Щебень: Шлаковый фр. 5-20">Шлаковый<br>фр. 5-20</div>
          <div class="col col_20" data-value="Щебень: Шлаковый фр. 20-40">Шлаковый<br>фр. 20-40</div>
          <div class="col col_20" data-value="Щебень: Шлаковый фр. 40-70">Шлаковый<br>фр. 40-70</div>
          <div class="col col_20" data-value="Щебень: Шлаковый фр. 70-120">Шлаковый<br>фр. 70-120</div>
          <div class="clearfix"></div>
        </div>
        <h4>Бут</h4>
        <div class="material_row">            
          <div class="col col_20" data-value="Бут: Горный">Бут<br>Горный</div>
          <div class="col col_20" data-value="Бут: Шлаковый">Бут<br>Шлаковый</div>
          <div class="col col_20" data-value="Бут: Скала">Скала</div>
          <div class="col col_20" data-value="Бут: ПВС">ПВС</div>
          <div class="col col_20" data-value="Бут: Гравий">Гравий</div>
          <div class="clearfix"></div>
        </div>
        <h4>Отсев</h4>
        <div class="material_row">            
      ...
      <div id="tonns">
        ...
        <div class="menu_button_wrapper">    
          <div id="tonns_count">
            <p>Количество:</p>
            <input type="text" placeholder="0" id="hi_vol" maxlength="6" size="7">
            <p>тонн</p>
          </div>
